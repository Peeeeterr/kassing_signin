...
if "%choice%"=="9" "%PYTHON_BIN%" main.py --dry-run & goto end_action
if "%choice%"=="10" "%PYTHON_BIN%" scripts\test_watermark.py & goto end_action
if "%choice%"=="11" "%PYTHON_BIN%" scripts\check_status.py & goto end_action
if "%choice%"=="12" "%PYTHON_BIN%" main.py -init & goto end_action
if "%choice%"=="13" "%PYTHON_BIN%" -m pip install -r requirements.txt & goto end_action
if "%choice%"=="0" exit /b 0
if /i "%choice%"=="q" exit /b 0

echo.
echo [提示] 输入无效，请输入 0 到 13 之间的数字。
